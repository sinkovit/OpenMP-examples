...
schedule_omp: schedule_omp.o
	$(CC) $(CFLAGS) $(OMPFLAGS) -o schedule_omp schedule_omp.o -lm

all: simple_loop_serial simple_loop_omp reduction_loop_omp reduction_loop2_omp nested_loops_omp collapse_omp schedule_omp

clean:
	rm -f *.o simple_loop_serial simple_loop_omp reduction_loop_omp reduction_loop2_omp nested_loops_omp collapse_omp schedule_omp
